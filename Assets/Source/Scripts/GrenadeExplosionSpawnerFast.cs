...
public class GrenadeExplosionSpawnerFast : MonoBehaviour
{
    ...
    {
        GrenadeExplosion explosion = Instantiate(fast_explosion, explosion_spawn_location, Quaternion.Euler(explosion_rotation));
